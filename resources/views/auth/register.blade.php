<x-guest-layout>
    <div class="w-full max-w-sm mx-auto">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Buat Akun Baru ✨</h3>
        <p class="text-gray-500 dark:text-gray-400 text-sm mb-8">Daftar untuk mulai mengelola inventaris.</p>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" 
                        class="pl-10 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-shadow py-2.5 sm:text-sm" placeholder="John Doe">
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" 
                        class="pl-10 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-shadow py-2.5 sm:text-sm" placeholder="john@example.com">
                </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            Sudah punya akun? 
            <a href="{{ route('login') }}" class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">Sign in di sini</a>
        </div>
    </div>
</x-guest-layout>
